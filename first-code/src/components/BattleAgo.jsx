                ...
                {this.state.oneKey ? (
                  <div>
                    <Card border="primary" style={{ width: '18rem' }} style={{ margin: '10px auto' }}>
                      <Card.Img variant="top" src= "https://ss0.bdstatic.com/70cFuHSh_Q1YnxGkpoWK1HF6hhy/it/u=188173295,510375359&fm=26&gp=0.jpg" alt="" className="lazyload" style={{ width: '200px', height: '200px', margin: '0 auto' }} />
                    ...
                    <div className="input">
                      ...
                      <InputGroup className="mb-3">
                        ...
                        />
                        <InputGroup.Append>
                          {this.state.userName1 !== "" && this.state.bKey1 ? <Button className='button' variant="primary" onClick={this.userSubmit}>Submit</Button> : <Button  disabled="disabled" variant="outline-secondary"> Input</Button>}
                        </InputGroup.Append>
                      </InputGroup>
                      {this.state.loadKey1 ? (
                  ...
                  <div>
                    ...
                    <div className="input">
                      ...
                      <InputGroup className="mb-3">
                        ...
                        />
                        <InputGroup.Append>
                          {this.state.userName2 !== "" && this.state.bKey2 ? <Button className='button' variant="primary" onClick={this.twoSubmit}>Submit</Button> : <Button  disabled="disabled" variant="outline-secondary" > Input</Button>}
                        </InputGroup.Append>
                      </InputGroup>
                      {this.state.loadKey2 ? (
